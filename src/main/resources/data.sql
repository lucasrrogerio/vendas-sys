...
INSERT INTO usuario (id, email, nome, senha, tipo_usuario) VALUES (nextval('hibernate_sequence'), 'rodrigo@id.uff.br', 'Rodrigo Werneck', '10293', 'VENDEDOR');
...
INSERT INTO produto (id, cod_barras, descricao, is_ativo, nome, preco, qtd_estoque, url_img, categoria_id, fornecedor_id, promocao_id)
